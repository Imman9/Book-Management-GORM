...
import (
	...
	"github.com/Imman9/go-postgres/models"
	"github.com/Imman9/go-postgres/storage"
...
func (r *Repository) CreateBook(context *fiber.Ctx) error {
	...
	context.Status(http.StatusOK).JSON(
		&fiber.Map{"message": "book has been found"})
	return nil
...
func (r *Repository) DeleteBook(context *fiber.Ctx) error {
	...
	context.Status(http.StatusOK).JSON(
		&fiber.Map{"message": "books deleted successfully"})
	return nil
}
